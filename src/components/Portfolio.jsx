        ...
        <>
            ...
            <section className="portfolio-section" id="portfolio">
                ...
                <div className="portfolios-group-main">
                    <div>
                        <div className="image-container popup-btn zoom_in" onClick={handlePopupOpen}>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <SoundCloudModal isOpen={isModalOpenSound} onRequestClose={handleCloseModalSound} />
                        </div>
                    </div>
                    <div className="gallery-bank-section">
                        <div className="zoom_in">
                            <div className="image-container">
                                <a href="#popup2">
                                    ...
                                    <div className="overlay">
                                        <img src={GallerySvg} alt="gallery-svg" className="vimeo-icon" />
                        ...
                        <div className="second-row-portfolio popup-btn zoom_in" onClick={handlePopupOpen}>
                            <div className="image-container">
                                <img src={ContentImg2} alt="content-img2" />
                                <div className="overlay">
                                    <img src={ContentSvg} alt="content-svg" className="vimeo-icon" />
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg1} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg2} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg3} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg4} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg5} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg6} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg7} data-fancybox="gallery" data-caption="Caption Images 1">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <Link to={Galleryimg8} data-fancybox="gallery" data-caption="Caption Images 1">
