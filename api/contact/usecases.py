...
class ContactApiUsecase(BaseApiUsecase):
    def submit_contact(self) -> bool:
        ...
        message = EmailMessage('You just contacted ruriazz', content, 'noreply@atmega.xyz', [self._context.data['senderEmail']])
        ...
        message = EmailMessage(subject='New Message for You', body=content, from_email='noreply@atmega.xyz', to=['azizruri.s@gmail.com'])
